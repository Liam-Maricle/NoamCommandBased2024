...
public class ArmPivotHighBasketCommand extends CommandBase
{ // The subsystem the command runs on
    private final ArmExtendSubsystem m_armExtendSubsystem;
    private final ArmPivotSubsystem m_armPivotSubsystem;

    public ArmPivotHighBasketCommand(ArmExtendSubsystem extendSubsystem, ArmPivotSubsystem pivotSubsystem)
    {
